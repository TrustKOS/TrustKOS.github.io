...
const teachInfo = {
    ...
    main: [
        ...
        },
        {
            title: "Recruitment",
            type: "custom",
            email: "contact via mail：songpy@tjnu.edu.cn",
            content: "We welcome undergraduate students majoring in Information Management and Information Systems, Library Science and Archives, Computer Science, Mathematics, Linguistics, Psychology, Journalism and Communication, Information-related fields, Management-related fields, or Science and Engineering-related fields to apply. We especially encourage outstanding talents with a strong interest in research, a kind-hearted and dedicated attitude, and a sense of gratitude to join the research group. We also warmly welcome relevant enterprises and institutions to carry out cooperative research."
        }
    ],
}
</script>